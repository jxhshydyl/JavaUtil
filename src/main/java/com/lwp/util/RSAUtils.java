...
public class RSAUtils {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("公钥key："+publicKey);
            //公钥加密
            String s = RSAUtils.encryptedDataOnJava(source, publicKey);
            System.out.println("公钥加密密文："+s);
            //获取私钥
            String privateKey = RSAUtils.getPrivateKey(map);
            System.out.println("私钥key："+privateKey);
            //私钥解密
            String s1 = RSAUtils.decryptDataOnJava(s, privateKey);
            System.out.println("私钥解密原文："+s1);
            System.out.println("============================加密密钥不同===============================");
